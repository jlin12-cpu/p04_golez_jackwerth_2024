# Dataframe: `P04:all_strip_prices` - 

Comprehensive panel of strip prices for all date-exdate combinations. Used to look up the current value of the previously selected strip when calculating holding-period returns.
...
$ strip_price          <f64> 226.02374911608968
...
| Dataframe Name                 |                                                    |
|--------------------------------|--------------------------------------------------------------------------------------|
| Dataframe ID                   | [all_strip_prices](../dataframes/P04/all_strip_prices.md)                                       |
| Data Sources                   | Derived from clean_options and implied_rates                                        |
| Data Providers                 | Internal pipeline                                      |
| Links to Providers             |                              |
| Topic Tags                     |                                           |
| Type of Data Access            |                                   |
| How is data pulled?            | Constructed by calc_strip_prices.py.                                                    |
| Data available up to (min)     | 2024-12-31 00:00:00                                                             |
| Data available up to (max)     | 2024-12-31 00:00:00                                                             |
| Dataframe Path                 | /Users/jielin/Desktop/full_stack/p04_golez_jackwerth_2024/_data/calc/all_strip_prices.parquet                                                   |
