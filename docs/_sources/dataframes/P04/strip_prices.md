...
| Dataframe Name                 |                                                    |
|--------------------------------|--------------------------------------------------------------------------------------|
| Dataframe ID                   | [strip_prices](../dataframes/P04/strip_prices.md)                                       |
...
| Dataframe Path                 | /Users/jielin/Desktop/full_stack/p04_golez_jackwerth_2024/_data/calc/strip_prices.parquet                                                   |
