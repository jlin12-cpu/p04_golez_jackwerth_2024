...
| Dataframe Name                 |                                                    |
|--------------------------------|--------------------------------------------------------------------------------------|
| Dataframe ID                   | [clean_rates](../dataframes/P04/clean_rates.md)                                       |
| Data Sources                   | Derived from fred_treasury_rates                                        |
...
| Dataframe Path                 | /Users/jielin/Desktop/full_stack/p04_golez_jackwerth_2024/_data/clean_rates.parquet                                                   |
