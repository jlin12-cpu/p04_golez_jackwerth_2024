...
# Chart: Figure 2 Extension
Extension of cumulative strip and market return paths through 2024.

## Chart
```{raw} html
<iframe src="../_static/P04/figure2_extension.html" height="500px" width="100%"></iframe>
...
```
[Full Screen Chart](../download_chart/P04/figure2_extension.html)





This figure extends the cumulative-return analysis beyond the paper sample using the automated pipeline's monthly return series.


## Chart Specs

| Chart Name             | Figure 2 Extension                                             |
|------------------------|------------------------------------------------------------|
| Chart ID               | figure2_extension                                               |
| Topic Tags             |                                 |
...
| Seasonal Adjustment    |                                     |
| Units                  |                                                   |
| HTML Chart             | [HTML](../download_chart/P04/figure2_extension.html)    |
