...
# Chart: Figure 2: Cumulative Returns
Replication of Figure 2 showing cumulative strip and market returns over 1996-2022.

## Chart
```{raw} html
<iframe src="../_static/P04/figure2.html" height="500px" width="100%"></iframe>
...
```
[Full Screen Chart](../download_chart/P04/figure2.html)





This figure plots cumulative wealth indices for a $1 investment in the strip and in the market under raw, risk-free excess, and Treasury excess definitions.


## Chart Specs

| Chart Name             | Figure 2: Cumulative Returns                                             |
|------------------------|------------------------------------------------------------|
| Chart ID               | figure2                                               |
| Topic Tags             |                                 |
...
| Seasonal Adjustment    |                                     |
| Units                  |                                                   |
| HTML Chart             | [HTML](../download_chart/P04/figure2.html)    |
