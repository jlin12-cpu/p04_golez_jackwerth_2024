...
## Chart
```{raw} html
<iframe src="../_static/P04/figure2_extension_winsorized.html" height="500px" width="100%"></iframe>
...
```
[Full Screen Chart](../download_chart/P04/figure2_extension_winsorized.html)
...
| Chart Name             | Figure 2 Extension (Winsorized)                                             |
|------------------------|------------------------------------------------------------|
| Chart ID               | figure2_extension_winsorized                                               |
| Topic Tags             |                                 |
...
| Seasonal Adjustment    |                                     |
| Units                  |                                                   |
| HTML Chart             | [HTML](../download_chart/P04/figure2_extension_winsorized.html)    |
