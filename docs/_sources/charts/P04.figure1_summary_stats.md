...
# Chart: Figure 1 Summary Statistics
Descriptive statistics and implied-zero spread chart for Figure 1.

## Chart
```{raw} html
<iframe src="../_static/P04/figure1_summary_stats.html" height="500px" width="100%"></iframe>

<p style="text-align: center;">Sources: Derived from implied_rates</p>
```
[Full Screen Chart](../download_chart/P04/figure1_summary_stats.html)





Descriptive statistics for the three interest rate series and a time series of the implied-minus-zero spread in basis points.


## Chart Specs

| Chart Name             | Figure 1 Summary Statistics                                             |
|------------------------|------------------------------------------------------------|
| Chart ID               | figure1_summary_stats                                               |
| Topic Tags             |                                 |
...
| Seasonal Adjustment    |                                     |
| Units                  |                                                   |
| HTML Chart             | [HTML](../download_chart/P04/figure1_summary_stats.html)    |
