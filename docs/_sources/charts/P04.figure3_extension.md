...
## Chart
```{raw} html
<iframe src="../_static/P04/figure3_extension.html" height="500px" width="100%"></iframe>
...
```
[Full Screen Chart](../download_chart/P04/figure3_extension.html)
...
| Chart Name             | Figure 3 Extension                                             |
|------------------------|------------------------------------------------------------|
| Chart ID               | figure3_extension                                               |
| Topic Tags             |                                 |
...
| Seasonal Adjustment    |                                     |
| Units                  |                                                   |
| HTML Chart             | [HTML](../download_chart/P04/figure3_extension.html)    |
