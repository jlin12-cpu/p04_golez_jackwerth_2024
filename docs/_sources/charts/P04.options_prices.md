...
# Chart: Distribution of SPX Option Prices
Histogram of option mid-prices showing right-skewed distribution. Most options priced under $500, with a long tail of expensive deep-in-the-money options.

## Chart
```{raw} html
<iframe src="../_static/P04/options_prices.html" height="500px" width="100%"></iframe>

<p style="text-align: center;">Sources: OptionMetrics IvyDB</p>
```
[Full Screen Chart](../download_chart/P04/options_prices.html)





Histogram of SPX option mid-prices across all month-end observations. Right-skewed distribution shows most options are relatively cheap (<$500), with a long tail of expensive deep-ITM or long-dated options.


## Chart Specs

| Chart Name             | Distribution of SPX Option Prices                                             |
|------------------------|------------------------------------------------------------|
| Chart ID               | options_prices                                               |
| Topic Tags             |                                 |
...
| Seasonal Adjustment    |                                     |
| Units                  |                                                   |
| HTML Chart             | [HTML](../download_chart/P04/options_prices.html)    |
