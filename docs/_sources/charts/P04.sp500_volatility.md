...
# Chart: S&P 500 Rolling Volatility
1-year rolling annualized volatility of S&P 500 returns. Highlights periods of market stress: 2008 financial crisis (>80% volatility) and 2020 COVID shock.

## Chart
```{raw} html
<iframe src="../_static/P04/sp500_volatility.html" height="500px" width="100%"></iframe>

<p style="text-align: center;">Sources: CRSP</p>
```
[Full Screen Chart](../download_chart/P04/sp500_volatility.html)





Rolling 252-day annualized volatility of S&P 500 daily returns. Shows volatility spikes during crisis periods (2008, 2020) and generally elevated volatility in recent years.


## Chart Specs

| Chart Name             | S&P 500 Rolling Volatility                                             |
|------------------------|------------------------------------------------------------|
| Chart ID               | sp500_volatility                                               |
| Topic Tags             |                                 |
...
| Seasonal Adjustment    |                                     |
| Units                  |                                                   |
| HTML Chart             | [HTML](../download_chart/P04/sp500_volatility.html)    |
